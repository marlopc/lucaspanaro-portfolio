...
const custom404Content = {
  en: {
    ...
    subheading: 'This page doesn\'t exist <span role="img" aria-label="panic">(●﹏●)</span>',
    link: 'Go to homepage',
  },
  es: {
    heading: '¿Cómo has llegado aquí?',
    subheading: 'Esta página no existe <span role="img" aria-label="pánico">(●﹏●)</span>',
...
const custom500Content = {
  en: {
    ...
    subheading: 'An unexpected error has occurred <span role="img" aria-label="sad">(’へ ’)</span>',
    link: 'Go to homepage',
  },
  es: {
    heading: 'Uhm... tenemos un problema.',
    subheading: 'Ocurrió un error inesperado <span role="img" aria-label="triste">(’へ ’)</span>',
    link: 'Volver al inicio',
  }
};
